...
const DeleteAction = props => {
    ...
    const [deleteThis, setDeleteThis] = useState(workflowTable != undefined)
            ...
            {!deleteThis &&
                (
                    <>
                        ...
                        <Grid container direction="row" alignItems="center" spacing={2}>
                            ...
                            {table.length > 0 &&
                                <Grid style={{ marginTop: "2em" }} container direction="row" alignItems="center" spacing={1}>
                                    <Grid item>
                                        <Typography style={{margin: "0.5em"}}>If they match the following criteria</Typography>
                                    </Grid>
                                    {workflowTable != undefined &&
                                        <Grid item>
                        ...
                        {workflowTable != undefined && workflowTable.length > 0 && <>
                            <Grid style={{ marginTop: "2em" }} container direction="row" alignItems="center" spacing={1}>
                                <Grid item>
